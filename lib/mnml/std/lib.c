...
module_entry_t ENTRIES[] = {
  ...
  LISP_MODULE_REGISTER(len),    LISP_MODULE_REGISTER(let),
  LISP_MODULE_REGISTER(list),   LISP_MODULE_REGISTER(load),
  LISP_MODULE_REGISTER(match),  LISP_MODULE_REGISTER(ns),
